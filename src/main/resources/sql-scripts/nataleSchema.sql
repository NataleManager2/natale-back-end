...
CREATE TABLE `activity` (
  ...
  CONSTRAINT `ACT_PROF_ID_FK` FOREIGN KEY (`ACT_PRO_ID`) REFERENCES `teacher` (`PRO_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `activity` VALUES (1,'CursoPrePartoNov','Grupo de preparto Noviembre','20:00:00','22:30:00',0,1960,1),(2,'BabyFitness','Gimnasia con bebé x dos','17:00:00','19:00:00',0,730,1),(3,'PrepartoEnero','Course Preparto Enero','20:30:00','23:00:00',0,2250,1),(4,'CursoPrePartoNov','Grupo Preparto Noviembre ','20:00:00','22:30:00',1,1400,1),(5,'Gym','Gimnasia embarazadas','18:30:00','20:00:00',0,530,1),(6,'Gym','Gimnasia embarazadas x dos','18:30:00','20:00:00',0,840,1),(7,'Gym','Gimnasia embarazadas x tres','18:30:00','20:00:00',0,880,1),(8,'BabyFitness','Gimnasia con bebé','17:00:00','19:00:00',0,430,1),(9,'BabyFitness','Gimnasia con bebé x tres','17:00:00','19:00:00',0,770,1),(10,'Preparto','Course Preparto Diciembre','20:00:00','22:30:00',0,1960,1),(11,'PrepartoEnero','Course Preparto Enero','20:00:00','22:30:00',0,1960,1);
...
CREATE TABLE `calendar` (
  ...
  CONSTRAINT `CAL_CUR_FK` FOREIGN KEY (`CAL_CUR_ID`) REFERENCES `course` (`CUR_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `course` (
  ...
  CONSTRAINT `CUR_PRO_FK` FOREIGN KEY (`CUR_PRO_ID`) REFERENCES `teacher` (`PRO_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `course` VALUES (1,'Primigestas','Course para mamás teniendo su primer embarazo.',NULL,NULL,3500,8,1);
...
INSERT INTO `teacher` VALUES (1,18304900,'Natalia Diaz','6714437','natalegym@gmail.com',0);
...
CREATE TABLE `workshop` (
  ...
  CONSTRAINT `TA_PRO_FK` FOREIGN KEY (`TA_PRO_ID`) REFERENCES `teacher` (`PRO_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `workshop` VALUES (1,'Lactancia','Para que las madres aprendar a amamantar.',1500,NULL,NULL,1);
